    ...
    <div v-show="showFlag" class="food" transition="move" v-el:food>
        <div class="food-content">
            ...
            <div class="content">
                ...
                <div class="detail">
                    <span class="sell-count">月售{{food.sllCount}}份</span>
            ...
            <div class="rating">
                ...
                <ratingselect :select-type="selectType" :only-content="onliyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
...
export default {
    ...
    methods:{
        show(){
            this.showFlag=true;
            this.selectType=ALL;
            this.onliyContent=true;
            this.$nextTick(()=>{
                if(!this.scroll){
                    this.scroll=new BScoller(this.$els.food,{
                        click:true
                    })
                }else{
                    this.scroll.refresh();
